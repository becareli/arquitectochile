    ...
    <div className="bg-gray-50 text-gray-900 font-sans leading-relaxed">
      ...
      <header className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-300 font-light mb-10">
            Gestión integral de Obras Menores y Regularizaciones para Grandes Empresas, Transnacionales y Retail.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a href="#contacto" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg transition duration-300">
              Agendar Diagnóstico Online Gratis
            </a>
            <a href="#visita" className="bg-white text-slate-900 hover:bg-gray-100 font-bold py-4 px-8 rounded-lg shadow-lg transition duration-300">
      ...
      <section className="py-12 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-center text-sm font-semibold text-gray-500 uppercase tracking-widest mb-8">Confían en nuestra gestión estratégica:</p>
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-slate-800 border-l-4 border-blue-600 pl-4">Donde la Eficiencia no es Negociable</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
            <Cpu className="text-blue-600 w-8 h-8 mb-4" />
            <h3 className="font-bold text-xl mb-2">Visualización de Vanguardia</h3>
            <p className="text-gray-600">Elimine la incertidumbre. Utilizamos tecnología de renderizado hiper-realista para que visualice el resultado final antes de la primera palada. Cero sorpresas.</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
            <Gavel className="text-blue-600 w-8 h-8 mb-4" />
            <h3 className="font-bold text-xl mb-2">Respaldo Normativo</h3>
            <p className="text-gray-600">Bajo la dirección de Patricio Becar (U. de Chile, MBA y Revisor Independiente MINVU), cada obra nace alineada con la LGUC para asegurar su Recepción Final.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="p-6">
              ...
              <p className="text-gray-600 italic">Salas eléctricas, celdas de control, centros de datos y casinos industriales.</p>
            </div>
            <div className="p-6">
              <h4 className="font-bold text-xl mb-3">Retail y Espacios de Marca</h4>
              <p className="text-gray-600 italic">Despliegue de tiendas de alto estándar donde el diseño es el vendedor silencioso.</p>
            </div>
            <div className="p-6">
              <h4 className="font-bold text-xl mb-3">Remodelaciones Críticas</h4>
              <p className="text-gray-600 italic">Oficinas de gerencia y áreas administrativas ejecutadas sin detener su operación.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contacto" className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto bg-slate-900 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
          ...
          <p className="text-xl text-blue-200 mb-12 italic">Seleccione el nivel de asesoría que su empresa requiere hoy:</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-blue-500 transition cursor-pointer">
              ...
              <p className="text-blue-300 text-sm mb-6 uppercase tracking-wider font-bold">Sin Costo - 15 Minutos Online</p>
              ...
              <a href="https://tidycal.com/arquitectopatriciobecar/" target="_blank" rel="noopener noreferrer" className="block w-full bg-blue-600 py-3 rounded-lg font-bold hover:bg-blue-500 transition">Agendar Videollamada</a>
            </div>

            <div id="visita" className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-green-500 transition cursor-pointer">
              <h3 className="text-2xl font-bold mb-4">Visita Técnica In Situ</h3>
              <p className="text-green-400 text-sm mb-6 uppercase tracking-wider font-bold">Inversión Profesional Reembolsable</p>
              ...
              <Link href="/contacto" className="block w-full bg-green-600 py-3 rounded-lg font-bold hover:bg-green-500 transition text-center">Solicitar Visita Presencial</Link>
            </div>
          </div>
