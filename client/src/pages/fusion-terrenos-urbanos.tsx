...
export default function FusionTerrenosUrbanos() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="mb-12">
            <div className="max-w-4xl mx-auto">
              <div className="relative bg-black rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 bg-[#0f172a]/90 text-white px-3 py-1 rounded text-sm font-semibold">
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-[#f97316]">$890.000</div>
                  <div className="text-lg text-gray-300">Inversión inicial</div>
                  <div className="text-sm text-gray-400">Retorno promedio: 300%-500%</div>
                </div>
                
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between items-center py-3 border-b border-white/20">
                    <span>Evaluación inicial</span>
                    <span className="text-[#f97316] font-semibold">GRATIS</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/20">
                    <span>Plano de fusión</span>
                    <span className="text-[#f97316] font-semibold">Incluido</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/20">
                    <span>Gestión completa</span>
                    <span className="text-[#f97316] font-semibold">DOM→SII→CBR</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span>Tiempo estimado</span>
                    <span className="text-[#f97316] font-semibold">45-60 días</span>
                  </div>
                </div>
                ...
                <Button 
                  ...
                  size="lg" 
                  className="w-full bg-[#f97316] text-white hover:bg-orange-600 text-xl py-4 rounded-lg"
                >
      ...
      {/* Problema - Pain Point */}
      <section className="py-16 bg-orange-50 border-l-8 border-[#f97316]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-[#0f172a] mb-2">Terreno Pequeño</h3>
              <p className="text-[#64748b]">No puedes construir el proyecto que realmente quieres</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">💸</div>
              <h3 className="font-bold text-[#0f172a] mb-2">Valor Estancado</h3>
              <p className="text-[#64748b]">Tu propiedad no aumenta de valor como debería</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🚫</div>
              <h3 className="font-bold text-[#0f172a] mb-2">Acceso Limitado</h3>
              <p className="text-[#64748b]">Solo tienes entrada por una calle o avenida</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#f97316]">
                <h3 className="text-xl font-bold text-[#0f172a] mb-3">Requisito Fundamental:</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold">Lotes Colindantes</h4>
                    <p className="text-[#64748b]">Los terrenos deben estar uno al lado del otro</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-[#64748b]">Una persona natural, jurídica o sucesión</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-[#64748b]">Mayor tamaño, más oportunidades</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748b]">Conoce exactamente cuándo es rentable y cuándo NO debes hacerlo</p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12">
            {/* Cuándo SÍ conviene */}
            <div className="bg-gray-50 p-8 rounded-xl border-2 border-gray-200">
              <h3 className="text-2xl font-bold text-[#0f172a] mb-6 text-center">✅ SÍ Conviene Fusionar</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#0f172a] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">1</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">DIMENSIÓN</h4>
                    <p className="text-gray-600">Si desea construir una edificación de mayor tamaño que no cabe en uno de los lotes iniciales.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#0f172a] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">2</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">ACCESIBILIDAD</h4>
                    <p className="text-gray-600">Si desea generar un nuevo acceso al terreno desde otra avenida, calle o pasaje.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#0f172a] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">3</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">VALOR DE MERCADO</h4>
                    <p className="text-gray-600">Si desea aumentar automáticamente el valor comercial de su terreno.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-50 p-8 rounded-xl border-2 border-orange-200">
              <h3 className="text-2xl font-bold text-[#0f172a] mb-6 text-center">❌ NO Conviene Fusionar</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#f97316] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">1</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">DIFERENTES DESTINOS</h4>
                    <p className="text-gray-600">Terreno Comercial + Habitacional = contribuciones aumentan al destino más caro (Comercial).</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#f97316] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">2</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">DISTINTA URBANIZACIÓN</h4>
                    <p className="text-gray-600">Fusionar terreno con urbanización completa + terreno con urbanización deficiente = tendrá que pagar toda la urbanización.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#f97316] text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">3</div>
                  <div>
                    <h4 className="font-bold text-[#0f172a]">NO HAY FUSIONES TRANSITORIAS</h4>
                    <p className="text-gray-600">Si se arrepiente, es muy difícil volver a subdividir. Es más fácil fusionar que subdividir.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="bg-[#f97316] text-white mb-4 text-lg px-6 py-3">
              EL SECRETO QUE LAS INMOBILIARIAS NO QUIEREN QUE SEPAS
            </Badge>
            <h2 className="text-4xl font-bold mb-6">
              El Artículo 63: Tu <span className="text-[#f97316]">Arma Secreta Legal</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#f97316]">
                <h3 className="text-xl font-bold text-[#0f172a] mb-3">Ejemplo Real:</h3>
                <p className="text-gray-600">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Calculator className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold">Aumento Automático de Valor</h4>
                    <p className="text-[#64748b]">Mayor capacidad = mayor valor comercial inmediato</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Building2 className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold">30% Más Construcción</h4>
                    <p className="text-[#64748b]">Beneficio garantizado por ley, no es negociable</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <MapPin className="h-6 w-6 text-[#0f172a] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold">Accesos Múltiples</h4>
                    <p className="text-[#64748b]">Entrada desde diferentes calles o avenidas</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#64748b]">26+ años perfeccionando este sistema</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-[#0f172a]">Municipalidad</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-[#0f172a]">Servicio SII</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-[#0f172a]">Conservador</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748b]">Lista completa de requisitos para cada etapa del proceso</p>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gray-100 p-6 rounded-lg max-w-3xl mx-auto">
              <h3 className="text-xl font-bold text-[#0f172a] mb-3">📝 Nosotros Gestionamos Todo</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748b]">Resolvemos las dudas más comunes sobre fusión de terrenos</p>
          </div>

          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="bg-gray-50 border-gray-200 rounded-lg px-6">
              <AccordionTrigger className="text-left text-lg font-bold text-[#0f172a] hover:text-[#0f172a]">
            ...
            <AccordionItem value="item-2" className="bg-gray-50 border-gray-200 rounded-lg px-6">
              <AccordionTrigger className="text-left text-lg font-bold text-[#0f172a] hover:text-[#0f172a]">
            ...
            <AccordionItem value="item-3" className="bg-gray-50 border-gray-200 rounded-lg px-6">
              <AccordionTrigger className="text-left text-lg font-bold text-[#0f172a] hover:text-[#0f172a]">
            ...
            <AccordionItem value="item-4" className="bg-gray-50 border-gray-200 rounded-lg px-6">
              <AccordionTrigger className="text-left text-lg font-bold text-[#0f172a] hover:text-[#0f172a]">
            ...
            <AccordionItem value="item-5" className="bg-gray-50 border-gray-200 rounded-lg px-6">
              <AccordionTrigger className="text-left text-lg font-bold text-[#0f172a] hover:text-[#0f172a]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-gray-50 p-6 rounded-lg">
              <Star className="h-8 w-8 text-[#0f172a] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-3">Arquitecto Universidad de Chile</h3>
              <p className="text-[#64748b]">26+ años de experiencia en proyectos arquitectónicos y fusiones de terrenos exitosas</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <Shield className="h-8 w-8 text-[#0f172a] mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-3">Ex-Funcionario Municipal</h3>
              <p className="text-[#64748b]">Trabajó en Direcciones de Obra, conoce el proceso desde adentro</p>
            </div>
          </div>
          ...
          <div className="bg-gray-100 p-8 rounded-lg">
            ...
            <p className="font-semibold text-[#0f172a]">- Patricio Becar Elissegaray, Arquitecto</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              onClick={handleContactClick}
              size="lg" 
              className="bg-[#f97316] text-white hover:bg-orange-600 text-xl px-8 py-4 rounded-lg"
            >
