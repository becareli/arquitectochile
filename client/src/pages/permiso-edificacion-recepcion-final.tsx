      ...
      <section className="relative bg-[#0f172a] text-white py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="rounded-lg bg-[#f97316] text-white mb-6 px-6 py-3 text-base font-bold animate-pulse">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  ...
                  size="lg" 
                  className="rounded-lg bg-[#f97316] hover:bg-orange-600 text-white font-bold text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all duration-300"
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/20">
              ...
              <div className="space-y-6">
                {[
                  { icon: FileText, title: "Permiso de Edificación", desc: "Aprobación en 15 días con revisor independiente", color: "text-[#f97316]" },
                  { icon: Building2, title: "Construcción Legal", desc: "Ejecuta tu obra con respaldo normativo completo", color: "text-[#f97316]" },
                  { icon: BadgeCheck, title: "Recepción Final", desc: "Certifica y legaliza tu propiedad para uso inmediato", color: "text-[#f97316]" }
                ].map((item, index) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {[
              { icon: AlertTriangle, text: "Su solicitud fue RECHAZADA por errores que no vio", color: "text-[#0f172a]" },
              { icon: Timer, text: "Lleva MESES esperando aprobación sin respuestas", color: "text-orange-600" },
              { icon: DollarSign, text: "Le cobraron MULTAS por construir sin permiso", color: "text-[#f97316]" },
              { icon: Home, text: "No puede VENDER porque falta recepción final", color: "text-[#0f172a]" }
            ].map((item, index) => (
              <Card key={index} className="border-2 hover:border-[#f97316] transition-all duration-300 shadow-lg">
          ...
          <div className="rounded-lg bg-[#f97316] text-white rounded-xl p-8 shadow-xl">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <Card className="border-4 border-[#0f172a] shadow-2xl">
            ...
            <Card className="border-4 border-[#f97316] shadow-2xl">
              <CardHeader className="rounded-lg bg-[#f97316] text-white">
              ...
              <CardContent className="pt-6 space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3">
                    <CheckCircle className="text-[#0f172a] flex-shrink-0 mt-1" size={24} />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-16">
            <Button 
              onClick={openWhatsApp}
              size="lg"
              className="bg-white text-[#f97316] hover:bg-gray-100 font-bold text-xl px-12 py-8 shadow-2xl hover:scale-105 transition-all duration-300"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="relative border-2 border-[#0f172a] hover:border-[#f97316] transition-all duration-300 shadow-xl hover:shadow-2xl">
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                  <div className="rounded-lg bg-[#f97316] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-2xl">
                    {step.step}
                  </div>
                </div>
                <CardHeader className="pt-10 text-center">
                  <step.icon className="text-[#0f172a] mx-auto mb-4" size={56} />
                  <CardTitle className="font-serif text-2xl text-[#0f172a] mb-2">{step.title}</CardTitle>
                  <Badge className="rounded-lg bg-[#f97316] text-white">{step.duration}</Badge>
                </CardHeader>
                <CardContent>
          ...
          <Card className="border-4 border-[#f97316] shadow-2xl">
            ...
            <CardContent className="pt-8 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-2xl text-[#0f172a]">✅ Nuestro Compromiso:</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-6 mb-12">
            {[
              ...
              <div key={index} className="flex items-center gap-4 bg-[#f97316]/20 border-2 border-[#f97316] rounded-lg p-6">
          ...
          <div className="rounded-lg bg-[#f97316] rounded-xl p-8 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button 
              onClick={openWhatsApp}
              size="lg"
              className="rounded-lg bg-[#f97316] hover:bg-orange-600 text-white font-bold text-xl px-12 py-8 shadow-2xl hover:scale-105 transition-all duration-300"
            ...
            <Button 
              ...
              size="lg"
              variant="outline"
              className="bg-white text-[#0f172a] hover:bg-gray-100 font-bold text-xl px-12 py-8 border-2 border-white shadow-xl"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-[#0f172a] text-white rounded-xl p-10 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                <Building2 className="text-[#f97316] mx-auto mb-4" size={48} />
                <h3 className="font-bold text-xl mb-2">Construcción Legal</h3>
                <p>Sin multas ni problemas</p>
              </div>
              <div>
                <BadgeCheck className="text-[#f97316] mx-auto mb-4" size={48} />
            ...
            <Button 
              onClick={openWhatsApp}
              size="lg"
              className="rounded-lg bg-[#f97316] hover:bg-orange-600 text-white font-bold text-xl px-16 py-8 shadow-2xl hover:scale-105 transition-all duration-300"
