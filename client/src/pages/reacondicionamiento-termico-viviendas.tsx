    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#0f172a] text-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <Badge className="bg-[#f97316] text-white mb-4 px-4 py-2 text-sm font-bold">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                DEJE DE GASTAR <span className="text-[#f97316]">FORTUNAS</span> EN CALEFACCIÓN
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button onClick={openWhatsApp} size="lg" className="bg-[#f97316] hover:bg-orange-600 text-white font-bold rounded-lg">
                  <Phone className="mr-2 h-5 w-5" />
                  CONSULTA GRATUITA
                </Button>
                <Button onClick={scrollToContact} size="lg" variant="outline" className="bg-white/20 text-white border-white hover:bg-white/30 rounded-lg">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-gray-50 border-l-4 border-[#0f172a] p-6 rounded-lg">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-6">
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-md border-l-4 border-[#0f172a]">
                <DollarSign className="w-8 h-8 text-[#0f172a] flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-[#0f172a] mb-2">Gastos que Nunca Terminan</h3>
                  <p className="text-[#64748b]">Cuentas de calefacción y aire acondicionado que aumentan cada año sin control</p>
                </div>
              </div>

              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-md border-l-4 border-[#f97316]">
                <HomeIcon className="w-8 h-8 text-[#f97316] flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-[#0f172a] mb-2">Incomodidad Constante</h3>
                  <p className="text-[#64748b]">No puede disfrutar de su propio hogar por el frío o calor extremo</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-md border-l-4 border-[#0f172a]">
                <Zap className="w-8 h-8 text-[#0f172a] flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-[#0f172a] mb-2">Problemas de Humedad</h3>
                  <p className="text-[#64748b]">Condensación y humedad por cambios bruscos de temperatura</p>
                </div>
              </div>

              <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-md border-l-4 border-[#f97316]">
                <TrendingDown className="w-8 h-8 text-[#0f172a] flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-[#0f172a] mb-2">Desvalorización</h3>
                  <p className="text-[#64748b]">Bajo valor de reventa por la ineficiencia energética de su propiedad</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -top-4 -left-4 bg-[#0f172a] text-white p-3 rounded-lg font-bold text-sm">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/20 rounded-lg p-4">
                <h4 className="font-bold text-[#f97316] mb-2">🧱 EIFS (Sistema EXTERIOR)</h4>
                ...
                <p className="text-xs mt-2 text-gray-300">Ideal para fachadas completas</p>
              </div>
              
              <div className="bg-white/20 rounded-lg p-4">
                <h4 className="font-bold text-[#f97316] mb-2">🏠 LANA MINERAL</h4>
                ...
                <p className="text-xs mt-2 text-gray-300">Excelente para techumbres</p>
              </div>
              
              <div className="bg-white/20 rounded-lg p-4">
                <h4 className="font-bold text-[#f97316] mb-2">🪟 TERMOPANEL</h4>
                ...
                <p className="text-xs mt-2 text-gray-300">Reduce pérdidas por ventanas</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-6 h-6 mr-3 text-[#f97316]" />
      ...
      {/* 6. ¿Qué Incluye Nuestro Diagnóstico? */}
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#0f172a] mb-6">
              ...
              <CardContent className="pt-6">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 text-[#0f172a] mr-2" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <Card className="bg-white text-gray-800">
              <CardContent className="p-6 text-center">
                <Phone className="w-12 h-12 text-[#0f172a] mx-auto mb-4" />
                <h3 className="font-bold text-lg mb-2 text-[#0f172a]">Consulta Inmediata</h3>
                <p className="text-sm mb-4 text-[#64748b]">Hable directamente con el arquitecto</p>
            ...
            <Card className="bg-white text-gray-800">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-lg mb-2 text-[#0f172a]">Formulario Completo</h3>
                <p className="text-sm mb-4 text-[#64748b]">Información detallada de su caso</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -top-2 -right-2 bg-[#0f172a] text-white p-2 rounded-lg font-bold text-xs">
                🔧 PROCESO TÉCNICO
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="bg-[#0f172a] text-white shadow-xl">
              <CardHeader className="text-center">
                ...
                <p className="text-gray-300 text-sm">Lana Mineral / Celulosa Proyectada</p>
              </CardHeader>
              <CardContent>
                <img 
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 mr-2 text-[#f97316]" />
            ...
            <Card className="bg-[#0f172a] text-white shadow-xl">
              <CardHeader className="text-center">
                ...
                <p className="text-gray-300 text-sm">Aislación Exterior Integral</p>
              </CardHeader>
              <CardContent>
                <img 
            ...
            <Card className="bg-[#0f172a] text-white shadow-xl">
              <CardHeader className="text-center">
                ...
                <p className="text-gray-300 text-sm">Alta Eficiencia Energética</p>
              </CardHeader>
              <CardContent>
                <img 
      ...
      {/* 9. Transparencia en la Inversión */}
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-[#0f172a] mb-6">
            ...
            <div>
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
                ...
                <ul className="space-y-3 text-left">
                  <li className="flex items-center text-[#64748b]">
                    <CheckCircle className="w-5 h-5 mr-3 text-[#0f172a]" />
              ...
              <div className="relative">
                <img 
                  ...
                  className="rounded-lg shadow-lg w-full"
                />
                <div className="absolute -top-2 -left-2 bg-[#0f172a] text-white p-2 rounded-lg font-bold text-xs">
                  💰 PRESUPUESTO CLARO
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="bg-white rounded-lg border border-gray-200 px-6">
              <AccordionTrigger className="text-left font-bold text-[#0f172a] hover:text-[#f97316] py-6">
