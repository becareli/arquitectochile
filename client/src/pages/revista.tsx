...
const videos = [
  ...
  { url: 'https://youtu.be/EnHBFo6UOS8', title: 'Planificación de Proyectos', description: 'Metodología para desarrollar construcciones' },
  { url: 'https://youtu.be/LxbHRbNXCh4', title: 'Casa Estilo Mediterráneo', description: 'Características del diseño mediterráneo' },
  { url: 'https://youtu.be/bh7eZ8X9mxU', title: 'Sistemas de Tabiquería', description: 'Construcción con estructuras de metalcon' },
  { url: 'https://youtu.be/NcLDm5RbJT8', title: 'Mansardas Habitables', description: 'Aprovechamiento de espacios bajo techo' },
  { url: 'https://youtu.be/Ne661ndvL8g', title: 'Claves para Construir', description: 'Fundamentos esenciales de construcción' },
  { url: 'https://youtu.be/-SIHxp1c_Ig', title: 'Testimonios de Clientes', description: 'Experiencias reales con nuestros servicios' },
  { url: 'https://youtu.be/spAhkKnNjts', title: 'Errores Comunes en Construcción', description: 'Prevención de fallas típicas' },
  { url: 'https://youtu.be/xK3fsZvJhx0', title: 'Preparación de Superficies', description: 'Técnicas previas al acabado' },
  { url: 'https://youtu.be/wJUwbeAwkY4', title: 'Sistemas de Techado', description: 'Instalación de techos continuos' },
  { url: 'https://youtu.be/BcGIoUDLNWg', title: 'Obra Gruesa Residencial', description: 'Estructuras principales de vivienda' },
  { url: 'https://youtu.be/zXAk4mk_154', title: 'Distribución Interior', description: 'Organización de espacios habitacionales' },
  { url: 'https://youtu.be/ApmGCWHk9Jw', title: 'Normativas de Construcción', description: 'Cumplimiento de rasantes urbanas' },
  { url: 'https://youtu.be/fDFaPcjqY1k', title: 'Cerramientos Estructurales', description: 'Técnicas de cierre de espacios' },
  { url: 'https://youtu.be/nrsek_GtvBg', title: 'Fundaciones para Vivienda', description: 'Bases estructurales para casas' },
  { url: 'https://youtu.be/MfjLf2Ax7tc', title: 'Ventanas de Alto Rendimiento', description: 'Sistemas de ventilación e iluminación' },
  { url: 'https://youtu.be/BRIS-vT2Kvg', title: 'Aislación Térmica', description: 'Eficiencia energética en viviendas' },
  { url: 'https://youtu.be/N-tYdckEG5Y', title: 'Perfiles de Aluminio', description: 'Sistemas de ventanas modernas' },
  { url: 'https://youtu.be/1bx78RgH2hE', title: 'Materiales de Construcción', description: 'Selección de insumos de calidad' },
